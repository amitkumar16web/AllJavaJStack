...
public class OrderDetails {
	...
	public static void main(String[] args) {
		...
		orderColl.add(new Product("Salt 1 pkt", 25.00));
		orderColl.add(new Product("Aata 1 kg", 40.00));
		orderColl.add(new Product("Onion 1 kg", 30.00));
		
		
		
		
		OrderDetails o2 = new OrderDetails("Amit","Assam",orderColl);
